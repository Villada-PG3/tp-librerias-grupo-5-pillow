...
class ImageEditor(QMainWindow):
    def __init__(self):
        ...
        # Botones para cargar y guardar imagen
        ...
        # Controles deslizantes para ajustar brillo, contraste y saturación
        ...
        self.saturation_slider.setMaximum(10)
        self.saturation_slider.setValue(0)
        self.saturation_slider.valueChanged.connect(self.adjust_saturation)
        saturation_layout.addWidget(self.saturation_slider)

        # Botones de rotación y volteo con íconos
        rotation_flip_layout = QHBoxLayout()
        controls_layout.addLayout(rotation_flip_layout)

        self.rotate_left_button = QPushButton(QIcon('rotate_left_icon.png'), '', self)
        self.rotate_left_button.clicked.connect(self.rotate_left)
        self.rotate_left_button.setToolTip('Rotate Left')
        rotation_flip_layout.addWidget(self.rotate_left_button)

        self.rotate_right_button = QPushButton(QIcon('rotate_right_icon.png'), '', self)
        self.rotate_right_button.clicked.connect(self.rotate_right)
        self.rotate_right_button.setToolTip('Rotate Right')
        rotation_flip_layout.addWidget(self.rotate_right_button)

        self.flip_horizontal_button = QPushButton(QIcon('flip_horizontal_icon.png'), '', self)
        self.flip_horizontal_button.clicked.connect(self.flip_horizontal)
        self.flip_horizontal_button.setToolTip('Flip Horizontal')
        rotation_flip_layout.addWidget(self.flip_horizontal_button)

        self.flip_vertical_button = QPushButton(QIcon('flip_vertical_icon.png'), '', self)
        self.flip_vertical_button.clicked.connect(self.flip_vertical)
        self.flip_vertical_button.setToolTip('Flip Vertical')
